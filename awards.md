...
- One **primary** showcase file per participant per season unless teams are pre-registered.  
- **Original work:** forks and tutorials must add **substantive** new engineering or integration.  
- **Safety:** dangerous demos without documented safeguards are ineligible.  
- **License compliance:** all models and media must respect licenses.

---

## Contact

Use the **Discord** and official email listed in [README.md](./README.md) for award disputes or edge-case eligibility questions.
